...
const Dashboard = () => {
  ...
  const statusChartData = {
    labels: ['Draft', 'To Be Reviewed', 'In Review', 'Completed'],
    datasets: [{
      data: [
        portfolios.draft.length,
  ...
  const getPortfoliosByUnit = () => {
    const allPortfolios = [...portfolios.draft, ...portfolios.toBeReviewed, ...portfolios.reviewed, ...portfolios.done];
    const unitCounts = {};
          ...
          <Col md={3}>
            <Card className="text-center">
              <Card.Body>
                ...
                <h2>{Object.values(portfolios).flat().length}</h2>
              </Card.Body>
            </Card>
          </Col>
          <Col md={3}>
                    ...
                    .map((portfolio, index) => (
                      <div key={index} className="mb-3 border-bottom pb-2">
                        ...
                        <small className="text-muted">
                          Unit: {portfolio.unit?.number} | Status: {portfolio.status}
                          <br />
